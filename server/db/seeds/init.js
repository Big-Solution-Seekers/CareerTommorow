...
exports.seed = async (knex) => {
  ...
  const programs = await knex('programs').insert([
    ...
    {
      fields_id: careerFields[1].id, name: 'Grace Institute', cost: "Free", url: 'https://graceinstitute.org/training-and-placement/', description: 'Project Coordinator, Executive Assistant', location: 'New York',
    ...
    },
    {
      ...
      fields_id: careerFields[2].id, name: 'NYU Dentistry', cost: "Free", url: 'https://pbs.twimg.com/profile_images/836338082186166272/jHNqYnDb_400x400.jpg', description: 'Dental Assistant',
